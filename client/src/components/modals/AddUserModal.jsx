    ...
    function AddUserModal({ isOpen, onClose }) {
      ...
      const { roles, isLoading: rolesLoading } = useSelector((state) => state.role); // Corrected this line
        ...
        <Modal isOpen={isOpen} onRequestClose={onClose} style={customModalStyles} contentLabel="Add User Modal">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="username" value={username} onChange={onChange} className="form-input" required />
                </div>
                <div className="relative">
                    <label className="block text-sm font-bold mb-2 text-gray-600">รหัสผ่าน</label>
                    <input type={showPassword ? 'text' : 'password'} name="password" value={password} onChange={onChange} className="form-input" required />
                ...
                <div className="relative">
                    ...
                    <input type={showPassword2 ? 'text' : 'password'} name="password2" value={password2} onChange={onChange} className="form-input" required />
                ...
                <div>
                    ...
                    <select name="role" value={role} onChange={onChange} className="form-input" required disabled={rolesLoading}>
