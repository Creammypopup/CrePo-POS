  ...
  return (
    <header className="bg-brand-header shadow-sm p-4 flex justify-between items-center h-14 flex-shrink-0 border-b border-gray-200/80">
      ...
      <div className="flex items-center space-x-6">
        ...
        <button onClick={onLogout} className="flex items-center text-gray-500 hover:text-brand-purple"><FaSignOutAlt size={20} className="mr-1" /><span className="hidden md:block">ออกจากระบบ</span></button>
      </div>
    </header>
  );
}
