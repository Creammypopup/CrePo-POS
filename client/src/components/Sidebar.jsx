        ...
        <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="paint0_linear_1_2" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#D9ACF5"/>
                    <stop offset="1" stopColor="#A076F9"/>
                </linearGradient>
                <linearGradient id="paint1_linear_1_2" x1="20" y1="5" x2="20" y2="35" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FFABE1"/>
                    <stop offset="1" stopColor="#D9ACF5"/>
                </linearGradient>
            </defs>
        </svg>
    );
      ...
      return (
        <>
          <aside
            ...
            className={`bg-[#FBF9FF] border-r border-gray-200/80 shadow-lg transition-all duration-300 ease-in-out flex flex-col h-screen ${
          ...
          >
            <div className="p-4 flex items-center justify-between border-b border-gray-200/80 h-16 flex-shrink-0">
              <div className="flex items-center gap-3">
                <AppLogo />
                {isSidebarOpen && <span className="text-2xl font-bold bg-gradient-to-r from-brand-purple to-brand-pink text-transparent bg-clip-text">CrePo-POS</span>}
              </div>
              <button
                onClick={(e) => {
                  e.stopPropagation();
