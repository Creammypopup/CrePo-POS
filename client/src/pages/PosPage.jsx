...
import { FaSearch, FaPlus, FaMinus, FaTrash, FaTimesCircle, FaUser, FaUserPlus, FaShoppingCart, FaPauseCircle, FaPlayCircle } from 'react-icons/fa';
                ...
                <div className="w-full md:w-2/5 bg-white/80 p-6 rounded-2xl shadow-lg flex flex-col">
                    <div className="flex items-center justify-between p-3 bg-blue-100 rounded-lg mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-blue-800">{selectedCustomer?.name || 'ยังไม่ได้เลือกลูกค้า'}</span>
                        </div>
                    ...
                    <div className="flex-grow overflow-y-auto pr-2 border-t pt-4">
                        {cart.length > 0 ? (
                            ...
                            <div className="text-center text-gray-400 mt-10 h-full flex flex-col justify-center items-center">
                    ...
                    <div className="border-t-2 pt-4 mt-4 space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button onClick={handleHoldBill} className="w-full btn bg-amber-200 text-amber-800 font-bold py-3 rounded-xl text-base hover:bg-amber-300">
                                <FaPauseCircle className="mr-2"/>พักบิล
                            </button>
                        ...
                        <button onClick={() => setIsPaymentModalOpen(true)} disabled={saleLoading || cart.length === 0} className="w-full bg-brand-purple text-white font-bold py-4 rounded-xl text-lg hover:bg-opacity-90 transition-all disabled:bg-gray-400 disabled:cursor-not-allowed">
                            ชำระเงิน
                        </button>
                    </div>
                </div>
