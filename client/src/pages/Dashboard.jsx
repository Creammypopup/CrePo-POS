...
import { FaDollarSign, FaReceipt, FaExclamationTriangle, FaPrint, FaTruck, FaUserFriends, FaArrowDown } from "react-icons/fa";
...
const lowStockData = [
    { name: 'ปูน TPI แดง', remaining: 5 },
    { name: 'ท่อ PVC 4 นิ้ว', remaining: 2 },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard icon={<FaUserFriends size={28} className="text-yellow-800" />} title="ลูกหนี้รอชำระ" value="2 ราย" color="from-yellow-200 to-yellow-100" />
      </div>
