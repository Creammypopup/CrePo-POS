              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="mb-6 relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-brand-purple"
                  >
                    {showPassword ? <FaEyeSlash /> : <FaEye />}
                  </button>
                </div>
                <div className="form-group">
                  <button type="submit" className="btn btn-3d-pastel btn-primary w-full flex items-center justify-center text-base">
